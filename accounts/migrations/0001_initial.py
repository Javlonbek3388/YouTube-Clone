# Generated by Django 5.0 on 2023-12-18 15:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_type', models.CharField(blank=True, choices=[('google', 'google'), ('email', 'email')], max_length=6, null=True)),
                ('auth_status', models.CharField(choices=[('sent_email', 'sent_email'), ('verify_code', 'verify_code'), ('personal_data', 'personal_data'), ('complate', 'complate')], default='sent_email', max_length=15)),
